...
find . -name "pom.xml" -exec sed \
     -e "s/\<artifactId\>adam-commands_2.10\<\/artifactId\>/\<artifactId\>adam-commands_2.11\<\/artifactId\>/g" \
     -e "s/\<name\>adam-commands_2.10\<\/name\>/\<name\>adam-commands_2.11\<\/name\>/g" \
